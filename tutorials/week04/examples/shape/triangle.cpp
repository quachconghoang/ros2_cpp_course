...
std::cout << "base_edge_.pointAboveLine(x, y)" << base_edge_.pointAboveLine(x, y) << std::endl;
std::cout << "left_edge_.pointAboveLine(x, y)" << left_edge_.pointAboveLine(x, y) << std::endl;
std::cout << "right_edge_.pointAboveLine(x, y)" << right_edge_.pointAboveLine(x, y) << std::endl;

//https://www.quora.com/Where-is-the-centre-of-mass-of-an-isosceles-triangle
    return (base_edge_.pointAboveLine(x, y)
           and (!left_edge_.pointAboveLine(x, y))
           and (!right_edge_.pointAboveLine(x, y)));
}
